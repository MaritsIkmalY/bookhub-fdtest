<div>
    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select
                        wire:model.live="filter_verified"
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        @if($filter_verified !== '')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                                {{ $filter_verified === '1' ? 'Verified' : 'Unverified' }}
                            </span>
                        @endif
                    </div>
                    <button
                        wire:click="clearFilters"
                        class="text-sm text-blue-600 hover:text-blue-500 dark:text-primary-400 dark:hover:text-primary-300"
                    >
                        Clear all filters
                    </button>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden relative">
            ...
            <div
                wire:loading.delay
                class="absolute inset-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm flex items-center justify-center z-10"
            >
                <div class="animate-spin h-6 w-6 border-2 border-gray-400 border-t-transparent rounded-full"></div>
                <span class="ml-2 text-sm text-gray-700 dark:text-gray-200">Loading…</span>
            </div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($users as $user)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900 dark:text-white">{{ $user->books_count }} books</span>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    ...
                                    @if($search || $filter_verified !== '')
                                        <button wire:click="clearFilters" class="mt-2 text-blue-600 hover:text-blue-500">
