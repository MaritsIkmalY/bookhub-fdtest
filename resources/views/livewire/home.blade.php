        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a wire:navigate href="{{ route('books') }}" class="flex items-center justify-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-900/30 transition">
                    ...
                    <a wire:navigate href="{{ route('users') }}" class="flex items-center justify-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition">
                    ...
                    <a wire:navigate href="{{ route('profile') }}" class="flex items-center justify-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition">
                    ...
                    <a wire:navigate href="{{ route('landing-page') }}" class="flex items-center justify-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a wire:navigate href="{{ route('books') }}" class="text-blue-600 hover:text-blue-500 text-sm">View all →</a>
                </div>
